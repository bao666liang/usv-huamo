...
figure(6);
subplot(311);
plot(t,abs(deata1)/1000,'r',t,DGJ(:,1)/1000,'linewidth',2.5);
ylabel('kN');
legend('\delta_1','\delta_1估计值');
subplot(312);
plot(t,abs(deata2)/1000,'r',t,DGJ(:,2)/1000,'linewidth',2.5);
ylabel('kN');
legend('\delta_2','\delta_2估计值');
subplot(313);
plot(t,abs(deata3)/1000,'r',t,DGJ(:,3)/1000,'linewidth',2.5);
xlabel('t/s');ylabel('kN\cdotm');
