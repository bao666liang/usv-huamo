...
% 控制器输出的推力减去观测器估计的干扰值为船舶的实际输入推力，
% 这时再加上真实扰动后会形成 d - d_jian 即扰动误差用反馈趋于零
% 这样就估计出真实扰动了
function [sys,x0,str,ts]=mdlInitializeSizes
sizes = simsizes;
sizes.NumContStates  = 3;%中间辅助状态向量beta
sizes.NumDiscStates  = 0;
sizes.NumOutputs     = 3;%干扰的估计值
sizes.NumInputs      = 6;%推进器力和V
