...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [sys,x0,str,ts] = sfun_ship_12(t,x,uss,flag)
switch flag,
  case 0,
  %Initialization
...
u00=2*1000*1.852/3600;%27.4 11.8 27.4
u0=u00;
v0=0*1852/3600.0;
r0=0;
psi0=75/57.3;%初始航向
n0=22/60.0;%154为全速,122   38.0  开始86
...
r=x(3); psi=x(4);
flow_Vc=uss(5)*1852/3600;%流速 1kn=1.852km/h
flow_psic=uss(6)*pi/180;%3.14159;%流出方向向
