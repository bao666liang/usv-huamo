...
sizes = simsizes;
sizes.NumContStates  =12;%x=[u; v; r; psi; n; Delta; p; phi; uabs; vabs; vx; vy; xg; yg]12个输出
sizes.NumDiscStates  = 0;
sizes.NumOutputs     =12;
sizes.NumInputs      = 8;%u=[delta,Qe,f_wind,a_wind,flow_Vc,flow_a,F,F_a]8个输入
...
u00=27.4*1.852/3.6;%27.4 11.8 27.4
u0=u00;
v0=0*1.852/3.6;
r0=0;
psi0=-0/57.3;%初始航向
...
Dj=1/20*(Delta_ord-Delta);% p138 3-5-124 lyb
if(abs(Dj)<=0.00001)		
    Dj=Delta_ord-Delta;
end
if(abs(Dj)>3*pi/180)
